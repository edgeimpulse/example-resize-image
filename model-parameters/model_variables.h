...
const ei_impulse_t impulse_54_0 = {
    .project_id = 54,
    .project_owner = "LocalOrg",
    .project_name = "Images",
    .impulse_id = 1,
    .impulse_name = "Fit longest",
    .deploy_version = 6,
...
ei_impulse_handle_t impulse_handle_54_0 = ei_impulse_handle_t( &impulse_54_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_54_0;
